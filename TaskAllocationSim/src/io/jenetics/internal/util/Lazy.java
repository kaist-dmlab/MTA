...
public final class Lazy<T> implements Supplier<T>, Serializable {
	...
	private Lazy(final T value, final boolean evaluated,
	 ...
	 *
	 * @param supplier
	 *            the lazy value supplier
	 * @param <T>
	 *            the value type
	 * @return a new lazy value initialization
	 * @throws java.lang.NullPointerException
	 *             if the given supplier is {@code null}
	 */
	 ...
	 *
	 * @param value
	 *            the value this {@code Lazy} object is initialized with
	 * @param <T>
	 *            the value type
